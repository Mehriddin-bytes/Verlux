                  ...
                  <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-2.5 border-2 rounded-lg focus:ring-2 outline-none transition-all text-sm text-gray-900 placeholder-gray-400 ${
                            touched.name && errors.name
                              ...
                              : "border-gray-200 bg-gray-50/50 focus:border-gray-700 focus:ring-gray-700/20 hover:border-gray-300 focus:bg-white"
                          }`}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-gray-700 focus:ring-2 focus:ring-gray-700/20 outline-none transition-all text-sm text-gray-900 bg-gray-50/50 hover:border-gray-300 focus:bg-white"
                          disabled={isSubmitting}
                        >
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <Button
                        ...
                        size="lg"
                        disabled={isSubmitting}
                        className="w-full bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-700 hover:to-cyan-600 text-white rounded-xl px-6 py-4 text-base font-black shadow-xl hover:shadow-2xl hover:shadow-gray-700/30 hover:scale-[1.01] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                      >
                        {isSubmitting ? (
                          <>
